...
async function warnCommand(sock, chatId, senderId, mentionedJids, message) {
    try {
        ...
        try {
            ...
            if (!isBotAdmin) {
                await sock.sendMessage(chatId, { 
                    text: '❌ Error: Please make TruvaGPT an admin first to use this command.'
                });
                return;
            }
            ...
            await sock.sendMessage(chatId, { 
                text: '❌ Error: Please make sure TruvaGPT is an admin of this group.'
            });
            return;
        }
        ...
        if (error.data === 429) {
            ...
            try {
                await sock.sendMessage(chatId, { 
                    text: '❌ Failed to warn user. Make sure TruvaGPT is admin and has sufficient permissions.'
                });
            } catch (sendError) {
