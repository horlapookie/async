...
const allCommands = [
    "help","menu","ping","alive","tts","owner","joke","quote","fact",
    "weather","news","attp","lyrics","8ball","groupinfo","staff",
    "vv","jid","trt","ss",
    "ban","kick","promote","demote","mute","unmute","delete","clear",
    "warn","warnings","antilink","antibadword","antitag","tag","tagall",
    "chatbot","resetlink","vcf","welcome","goodbye",
    "mode","update","setpp","clearsession","cleartmp","autostatus",
    "autoreact","autotyping","autoread","anticall",
    "blur","crop","simage","sticker","take","meme","emojimix","igs","igsc",
    "removebg","remini",
    "pies","china","indonesia","japan","korea","hijab",
    "tictactoe","hangman","guess","trivia","answer","truth","dare",
    "truvagpt","gemini","imagine","flux","bot",
    "compliment","insult","flirt","shayari","goodnight","roseday",
    "character","wasted","ship","simp","stupid",
    "metallic","ice","snow","matrix","neon","devil","purple","thunder",
    "light","arena","hacker","sand","blackpink","glitch","fire",
    "play","song","ytmp4","video","instagram","facebook","tiktok","movie",
    "createapi","dev","developer","tempnum","templist","otpbox",
    "heart","horny","circle","lgbt","lolice","namecard","oogway","tweet",
    "ytcomment","jail","passed","triggered","glass",
    "neko","waifu","loli","nom","poke","cry","kiss","pat","hug","wink","facepalm",
    "git","github","sc","repo"
];
      ...
      //  if (!message.key.fromMe) incrementMessageCount(chatId, senderId);
        ...
        switch (true) {
            ...
            case userMessage.startsWith('/dev') || 
                 ...
                 userMessage.startsWith('/about') || 
                 userMessage.startsWith('/source'):
           ...
           case userMessage.startsWith('/sinhalasub') || userMessage.startsWith('/movie'):
            ...
            case userMessage.startsWith('/instagram') || userMessage.startsWith('/insta') || userMessage.startsWith('/ig'):
                ...
                break;
                case userMessage.startsWith('/truvagpt'):
